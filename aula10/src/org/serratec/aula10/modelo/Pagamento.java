...
public abstract class Pagamento {
    ...
    public static final double JUROS_DIA = 0.15;
    ...
    private long calcularDiasEmAtraso() {
    ...
    public final double calcularMultaEAtraso() {
        ...
        double jurosAtraso = diasAtraso * JUROS_DIA;
        return valorMulta + jurosAtraso;
    }

    public abstract void realizarPagemento();
}
